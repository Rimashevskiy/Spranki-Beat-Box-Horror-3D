...
public class FracturedChunkEditor : Editor
{
    ...
    public void OnSceneGUI()
    {
        ...
        if (bDrawLines)
        {
            ...
            {
                Handles.DotHandleCap(0, fracturedChunk.transform.position, Quaternion.identity, HandleUtility.GetHandleSize(fracturedChunk.transform.position) * 0.03f, EventType.Used);
            }
            ...
            foreach (FracturedChunk.AdjacencyInfo chunkAdjacency in fracturedChunk.ListAdjacentChunks)
            {
                ...
                {
                    Handles.DotHandleCap(0, chunkAdjacency.chunk.transform.position, Quaternion.identity, HandleUtility.GetHandleSize(chunkAdjacency.chunk.transform.position) * 0.03f, EventType.Used);
